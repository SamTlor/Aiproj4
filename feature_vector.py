...
def process_paragraphs(paragraphs, stop_words):
    ...
    for paragraph in paragraphs:
        ...
        stemmed_words = [stemmer.stem(word, 0, len(word) - 1) for word in words if word not in stop_words and word != "<br />"]

        # Count word frequencies
        word_freq = Counter(stemmed_words)

        # Add to the list of processed paragraphs
        processed_paragraphs.append(word_freq)
